...
{
    [CreateAssetMenu(fileName = nameof(Currency), order = CelesteMenuItemConstants.WALLET_MENU_ITEM_PRIORITY, menuName = CelesteMenuItemConstants.WALLET_MENU_ITEM + "Currency")]
