...
{
    [CreateAssetMenu(fileName = nameof(JsonUtilityNetworkingMessageSerializer), menuName = CelesteMenuItemConstants.WEB_MENU_ITEM + "Serializers/Json Utility", order = CelesteMenuItemConstants.WEB_MENU_ITEM_PRIORITY)]
