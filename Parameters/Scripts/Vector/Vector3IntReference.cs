...
{
    [CreateAssetMenu(fileName = "Vector3IntReference", menuName = CelesteMenuItemConstants.PARAMETERS_MENU_ITEM + "Vector/Vector3Int Reference", order = CelesteMenuItemConstants.PARAMETERS_MENU_ITEM_PRIORITY)]
