...
{
    [AddComponentMenu("Celeste/Deck Building/Discard Pile")]
    public class DiscardPile : MonoBehaviour, ICardStorage
    {
        ...
        {
            UnityEngine.Debug.Assert(card != null, $"Inputting null card into {nameof(DiscardPile.AddCard)}.");
            cards.Add(card);
