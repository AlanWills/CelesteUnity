...
"}}\n";
        ...
        private void OnWizardOtherButton()
        {
            ...
            if (generateEventClasses)
            {
                // Event
                {
                    string eventFileContents = string.Format(EVENT_CLASS_FORMAT, namespaceName, typeName, arguments, eventCreateAssetMenuPath);
                ...
                // Event Listener
                {
                    string eventListenerFileContents = string.Format(EVENT_LISTENER_CLASS_FORMAT, namespaceName, typeName, arguments);
                ...
                // Event Raiser
                {
                    string eventRaiserFileContents = string.Format(EVENT_RAISER_CLASS_FORMAT, namespaceName, typeName, arguments);
            ...
            if (generateValueChangedEventClasses)
            {
                // Value Changed Event
                {
                    string valueChangedEventFileContents = string.Format(VALUE_CHANGED_EVENT_CLASS_FORMAT, namespaceName, capitalisedTypeName, arguments, valueChangedEventCreateAssetMenuPath);
                ...
                {
                    string valueChangedEventListenerFileContents = string.Format(VALUE_CHANGED_EVENT_LISTENER_CLASS_FORMAT, namespaceName, capitalisedTypeName, arguments);
                ...
                {
                    string valueChangedEventRaiserFileContents = string.Format(VALUE_CHANGED_EVENT_RAISER_CLASS_FORMAT, namespaceName, capitalisedTypeName, arguments);
